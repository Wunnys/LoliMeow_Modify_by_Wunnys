...
var edit_mode = '1', // 再编辑模式( '1'=打开; '0'=关闭 )
		...
		txt3 = '"> <div id="edita" class="alert alert-success alert-dismissible">提交成功！',
...
/** Ajax */
	$.ajax( {
		...
		error: function(request) {
			$('#loading').slideUp();
			$('#error').slideDown().html('<img src="' + pic_no + '" style="vertical-align:middle;" alt="img"/> ' + request.responseText);
